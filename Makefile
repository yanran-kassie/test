...
TARGETS = close1 creat1 open1 read1 unlink1 write2 exit1 exec1 join1 execargh1 except1 halt sh matmult sort echo cat cp mv rm write1 write4 write10 snake
